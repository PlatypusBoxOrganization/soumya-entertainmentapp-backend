...
const MovieDetails = () => {
  ...
  useEffect(() => {
    const fetchMovieDetails = async () => {
      try {
        const response = await fetch(`https://www.omdbapi.com/?apikey=thewdb&i=${id}`);
        ...
        if (data.Response === "True") {
          ...
          const isInBookmarks = bookmarkedMovies.some(bm => bm.id === formattedMovie.id);
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-2xl font-semibold text-indigo-500">{movie.imdbRating}</span>
                  </div>
